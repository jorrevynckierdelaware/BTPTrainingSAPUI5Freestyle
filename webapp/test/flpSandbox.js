		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training BTP Northwind",
									"targetURL": "#bedelawareztrainingbtp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bedelawareztrainingbtp-display": {
								"semanticObject": "bedelawareztrainingbtp",
								"action": "display",
								"description": "Training BTP Northwind Exercise",
								"title": "Training BTP Northwind",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.delaware.ztrainingbtp",
									"url": sap.ui.require.toUrl("be/delaware/ztrainingbtp")
								}
							}
						}
					}
